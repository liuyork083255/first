...
public class MqManager
{
    ...
    public void init0()
    {
        this.host = config.getRabbitmqHost();
        this.port = config.getRabbitmqPort();
    }
    ...
    public synchronized Receiver getReceiver(String exchange, CreateOptions.SenderType type, MqReceiverCallback mqReceiverCallback, boolean isSingleThread)
    {
    ...
    public synchronized Receiver getReceiver(String exchange, String type, MqReceiverCallback mqReceiverCallback,boolean isSingleThread)
    {
        return getReceiver(exchange, getSenderType(type), mqReceiverCallback, isSingleThread);
    }
